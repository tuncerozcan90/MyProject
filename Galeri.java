...
public class Galeri {
    ...
    public static void aracBilgileriniGosterIndex(Otomobil birObje) { //! GALERIYE DEFAULT ARACLARI EKLER
    ...
    public static void aracBilgileriniGosterIndex(SUV birObje) { //! GALERIYE DEFAULT ARACLARI EKLER
    ...
    public static void aracBilgileriniGosterIndex(Karavan birObje) { //! GALERIYE DEFAULT ARACLARI EKLER
