...
public class Karavan extends Arac {
    ...
    public void aracBilgileriGoster() {     //! TUM KARAVAN BILGILERINI YAZDIR
        for (int i = 0; i < Galeri.GaleridekiKaravanlar.size(); i++, Arac.sayac++) {
            ...
            System.out.println("Ustu acik mi: " + Galeri.GaleridekiKaravanlar.get(i).isUstuAcik());
            ...
            System.out.println("Duz vites mi: " + Galeri.GaleridekiKaravanlar.get(i).isaracDuzVites());
    ...
    @Override
    public void aracBilgileriniGosterIndex(int index) { //! KARAVAN EKLE
