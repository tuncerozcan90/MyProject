...
public class Otomobil extends Arac {
    ...
    public void aracBilgileriGoster() { //! TUM OTOMOBIL BILGILERINI YAZDIR
        ...
        for (int i = 0; i < Galeri.GaleridekiOtomobiller.size(); i++, Arac.sayac++) {
            ...
            System.out.println("Ustu acik mi: " + Galeri.GaleridekiOtomobiller.get(i).isUstuAcik());
            ...
            System.out.println("Duz vites mi: " + Galeri.GaleridekiOtomobiller.get(i).isaracDuzVites());
    ...
    @Override
    public void aracBilgileriniGosterIndex(int index) {   //! OTOMOBIL EKLE
