...
public class SUV extends Arac {
    ...
    public void aracBilgileriGoster() { //! TUM SUV BILGILERINI YAZDIR
        for (int i = 0; i < Galeri.GaleridekiSUVlar.size(); i++, Arac.sayac++) {
            ...
            System.out.println("Ustu acik mi: " + Galeri.GaleridekiSUVlar.get(i).isUstuAcik());
            ...
            System.out.println("Duz vites mi: " + Galeri.GaleridekiSUVlar.get(i).isaracDuzVites());
            ...
            System.out.println("Arazi tipi mi: " + Galeri.GaleridekiSUVlar.get(i).isSuvArazi());
            System.out.println("Tekerlek tipi: " + Galeri.GaleridekiSUVlar.get(i).getSuvTekerlekTipi());
            System.out.println("Vinc var mi: " + Galeri.GaleridekiSUVlar.get(i).isSuvVinc());
            System.out.println();
         }
    }

    @Override
    public void aracBilgileriniGosterIndex(int index) {   //! SUV EKLE
